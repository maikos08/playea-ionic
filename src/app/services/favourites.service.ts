...
export class FavoritesService {
  ...
  async addFavoriteBeach(userId: string | undefined, beachId: string): Promise<void> {
    try {
  ...
  async removeFavoriteBeach(userId: string | undefined, beachId: string): Promise<void> {
    try {
      const userDocRef = doc(this.firestore, `Users/${userId}`);
      await updateDoc(userDocRef, {
